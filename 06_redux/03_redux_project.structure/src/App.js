/*
 * react-router-dom: react 포르젝트의 router를 처리할 수 있도록 하는 것이다. (페이지 이동과 같은 기능)
 ...
 * redux-devtools-extension: 크롬의 별도 extension으로 설치되어 리덕스가 가지고 있는 장점 중 하나인 타입스냅샷(state의 변화 내용의 기록함)을 이용하여 이전의 상태로 돌아가거나 현재의 상태를 표시하는 툴
*/
